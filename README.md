...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/python-suitesparse-graphblas-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-suitesparse-graphblas-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12611&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/python-suitesparse-graphblas-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_64_python3.14.____cp314t" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
pixi add python-suitesparse-graphblas
# for installing globally
pixi global install python-suitesparse-graphblas
```
...
It is possible to list all of the versions of `python-suitesparse-graphblas` available on your platform:
...
```
pixi search python-suitesparse-graphblas --channel conda-forge
```
